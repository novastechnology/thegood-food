document.addEventListener("DOMContentLoaded", function () {
  ...
  /* Multi-Commodity Category Tabs */
  document.querySelectorAll(".commodity-tabs-nav").forEach(function (tabNav) {
    var buttons = tabNav.querySelectorAll(".commodity-tab-btn");
    var targetContainer = document.querySelector(tabNav.dataset.targetContainer || ".commodity-panels-container");
    if (!targetContainer) return;

    var panels = targetContainer.querySelectorAll(".commodity-panel");

    buttons.forEach(function (btn) {
      btn.addEventListener("click", function () {
        var targetCategory = btn.dataset.category;
  ...
  /* Port-to-Port Matrix Tabs */
  document.querySelectorAll(".matrix-tabs").forEach(function (matrixNav) {
    var buttons = matrixNav.querySelectorAll(".matrix-tab-btn");
    var container = document.querySelector(".matrix-content-container");
    if (!container) return;

    var panels = container.querySelectorAll(".matrix-panel");
